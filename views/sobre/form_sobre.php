            ...
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Cadastro de Sobre a Empresa</h3>
                </div>
                <form method="post" action="cadastro_sobre.php">
                  <div class="card-body">
                    <div class="form-group">
                      <div class="col-12  mb-3">
                        <label for="exampleInputEmail1">Sobre a Empresa</label>
                        <textarea class="form-control" name="sobre_empresa" rows="3" placeholder="Insira a descrição"></textarea>
                      </div>
                      <div class="col-md-12">
