...
$sql = "select *,
        date_format(sob_data_cadastro,'%d/%m/%Y') as data_cadastro
     from sobre";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listagem de Sobre a Empresa</h3>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td><?php echo $dados['sob_id'] ?></td>
                        <td><?php echo $dados['sob_texto'] ?></td>
                        <td><?php echo $dados['data_cadastro'] ?></td>
                        <td>
                        <a style="padding: 7px;" href="delete_sobre.php?sob_id=<?php echo $dados['sob_id']; ?>" onclick="excluir_registro(event)"><i class="fa-solid fa-trash"></i></a>
                          <a style="padding: 7px;" href="form_atualizar_sobre.php?sob_id=<?php echo $dados['sob_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                  </tbody>
