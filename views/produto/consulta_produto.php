...
$sql = "select *,
        date_format(pro_data_cadastro,'%d/%m/%Y') as data_cadastro
     from produto";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listagem de Produto</h3>
                  ...
                  <tbody>
                    <?php while ($dados = mysqli_fetch_array($sql)) { ?>
                      <tr>
                        ...
                        <td>
                          <a style="padding: 7px;" href="delete_produto.php?pro_id=<?php echo $dados['pro_id']; ?>" onclick="excluir_registro(event)"><i class="fa-solid fa-trash"></i></a>
                          <a style="padding: 7px;" href="form_atualizar_produto.php?pro_id=<?php echo $dados['pro_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
