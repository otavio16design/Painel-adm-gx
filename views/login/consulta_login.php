...
$sql = "select *,
        date_format(log_data_cadastro,'%d/%m/%Y') as data_cadastro
     from tb_login";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listagem de Usuário</h3>
                  ...
                  <tbody>
                    <?php while ($dados = mysqli_fetch_array($sql)) { ?>
                      <tr>
                        ...
                        <td>
                          <a style="padding: 7px;" href="delete_login.php?log_codigo=<?php echo $dados['log_codigo']; ?>" onclick="excluir_registro(event)"><i class="fa-solid fa-trash"></i></a>
                          <a style="padding: 7px;" href="form_atualizar_login.php?log_codigo=<?php echo $dados['log_codigo']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
