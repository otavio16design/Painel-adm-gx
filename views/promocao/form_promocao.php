            ...
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Cadastro de Promoção</h3>
                </div>
                <form method="post" action="cadastro_promocao.php" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <div class="col-12  mb-3">
                        <label >Produto</label>
                        <input type="text" class="form-control" name="produto" placeholder="Insira o produto">
                      </div>
                      <div class="col-12  mb-3">
                        <label >% Off</label>
                        <input type="number" class="form-control" name="porcentagem" placeholder="Insira a % off">
                      </div>
                      <div class="col-12  mb-3">
                        <label for="exampleInputFile">Imagem</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" name="txt_imagem" class="custom-file-input" name="txt_imagem" id="exampleInputFile">
                      ...
                      <div class="col-12  mb-3">
                        ...
                        <input type="text" class="form-control"  name="link" placeholder="Insira o o link de compra">
                      </div>
                    </div>
