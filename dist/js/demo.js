...
(function ($) {
  ...
  $container.append(
    '<h5>Customizar Painel</h5><hr class="mb-2"/>'
  )
  ...
  var $dropdown_legacy_offset_container = $('<div />', { class: 'mb-1' }).append($dropdown_legacy_offset_checkbox).append('<span>Deslocamento da Lista</span>')
  ...
  $container.append('<h6>Opções da Barrra Lateral</h6>')
  ...
  var $sidebar_collapsed_container = $('<div />', { class: 'mb-1' }).append($sidebar_collapsed_checkbox).append('<span>Encurtado</span>')
  ...
  var $sidebar_mini_container = $('<div />', { class: 'mb-1' }).append($sidebar_mini_checkbox).append('<span>Mini Barra</span>')
  ...
  var $flat_sidebar_container = $('<div />', { class: 'mb-1' }).append($flat_sidebar_checkbox).append('<span>Lista Curta</span>')
  ...
  var $legacy_sidebar_container = $('<div />', { class: 'mb-1' }).append($legacy_sidebar_checkbox).append('<span>Lista Fechada</span>')
  ...
  var $compact_sidebar_container = $('<div />', { class: 'mb-1' }).append($compact_sidebar_checkbox).append('<span>Lista Compacta</span>')
